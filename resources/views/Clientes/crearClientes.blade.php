	...
	<form method="POST" action="{{route('Clientes.store')}}">
		...
		<div class="form-group col-md-5">
			...
			<input type="text" class="form-control" id="idtelefonoC" name="idtelefonoC"
				placeholder="Escribe tu telefono..." value="{{ old('idtelefonoC') }}">
...
<div class="form-row">
	<div class="form-group col-md-5">
		<label>NIT</label>
		<input type="numeric" class="form-control" id="NIT" name="NIT" placeholder="Escribe tu NIT..."
			value="{{ old('NIT') }}">
		<span id="msgidnombre" name="msgidnombre" class="AlertaMsg"></span>
	</div>
	<div class="form-group col-md-5">
		<label>Numero Consumidor Final</label>
		<input type="numeric" class="form-control" id="NCF" name="NCF" placeholder="N° consumidor final..."
			value="{{ old('NCF') }}">
		<span id="msgidnombre" name="msgidnombre" class="AlertaMsg"></span>
	</div>
